...
def main():
    ...
    functions_write_score_list.add_text_to_video(FILE_NAME_FOR_SUMMARY, FILE_NAME_FOR_SUMMARY_WITH_TEXT, times, who_score)

if __name__ == "__main__":
    FILE_NAME_FOR_SUMMARY = 'result_video/summary_game14_2025.mp4'
    FILE_NAME_FOR_SUMMARY_WITH_TEXT = 'result_video/summary_game14_2025_with_score.mp4'
